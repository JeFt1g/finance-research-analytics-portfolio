# Limits to Arbitrage Shleifer Vishny 1997 - Flashcards
...
A mispricing is not automatically a profit. Traders need capital, time, borrow, liquidity, and investor patience. If the mispricing widens before it closes, margin calls, redemptions, or career risk can force exit before the thesis works.
...
- Q: What is the core idea? A: Limits to Arbitrage explains why mispricings can persist even when rational traders see them.
- Q: Why does it matter? A: It gives the practical layer missing from simple efficient-market stories: funding pressure, liquidity, short constraints, and forced exits.
- Q: What is one limitation? A: Constraints are hard to observe before stress arrives.
- Q: What can this become in software? A: Mispricing persistence tracker
- Q: Which theory should it be compared with? A: [Market Efficiency](../02-market-efficiency-fama-1970/README.md)
