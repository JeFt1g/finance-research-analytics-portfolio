# Black-Scholes 1973 - Real-World Examples
...
- why options were hard to price before closed-form models
- historical volatility vs implied volatility
- why longer time and higher volatility usually increase option value
- why crashes expose model assumptions
