...
An option can be replicated with a dynamic position in the stock and a risk-free bond. If the replicated payoff is the same, no-arbitrage logic forces the option price toward the cost of that portfolio. Volatility is central because option payoff is asymmetric: upside can be large while loss is limited to the premium.
...
- Q: What is the core idea? A: Black-Scholes prices European options from spot price, strike, time, rates, and volatility.
- Q: Why does it matter? A: It turned option pricing from dealer intuition into a repeatable model for quoting, hedging, and building derivatives software.
- Q: What is one limitation? A: Assumes European exercise and frictionless continuous hedging.
- Q: What can this become in software? A: Option pricing calculator
