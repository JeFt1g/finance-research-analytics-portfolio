# Arbitrage Pricing Theory Ross 1976 - Flashcards
...
APT starts from no-arbitrage logic: assets with the same factor exposures should not have persistently different expected returns. Instead of one market factor, it can use inflation, rates, GDP growth, credit spreads, oil prices, or style factors.
...
- Q: What is the core idea? A: APT models expected return as compensation for exposure to multiple risk factors.
- Q: Why does it matter? A: It expands CAPM's one-beta view into a flexible factor framework closer to modern risk systems.
- Q: What is one limitation? A: APT does not tell you exactly which factors to use.
- Q: What can this become in software? A: Multi-factor stock model
