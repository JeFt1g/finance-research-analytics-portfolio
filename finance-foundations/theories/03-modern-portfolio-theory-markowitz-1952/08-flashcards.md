# Modern Portfolio Theory Markowitz 1952 - Flashcards
...
Markowitz moved finance from evaluating assets one by one to evaluating how assets behave together. A risky asset can reduce total portfolio risk if it does not move in lockstep with the rest of the portfolio. Return is a weighted average, but risk depends on covariance.
...
- Q: What is the core idea? A: MPT says portfolio risk depends on weights, volatility, and correlation, not just individual asset risk.
- Q: Why does it matter? A: It is the foundation for diversification, asset allocation, efficient frontiers, and risk-aware portfolio software.
- Q: What is one limitation? A: Expected returns and correlations are noisy estimates.
- Q: What can this become in software? A: Portfolio optimizer
- Q: Which theory should it be compared with? A: [CAPM](../04-capm-sharpe/README.md)
