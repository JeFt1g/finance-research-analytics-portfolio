...
REPORT = PROJECT_DIR / "outputs" / "reports" / "portfolio_analysis_report.md"
...
def main() -> None:
    ...
    st.set_page_config(page_title="Python Portfolio Analysis", layout="wide")
    st.title("Python Portfolio Analysis")
    st.write("Portfolio return, volatility, Sharpe ratio, drawdown, allocation, and correlation dashboard.")
